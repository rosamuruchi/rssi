...
$query_ganancia = "SELECT ip, id_equipo, device_name, location FROM equipos WHERE ip LIKE '$IPE' ORDER BY location DESC, device_name ASC";
$id_equipo_array= [];
...
console.log("Estoy en dyn_tables_evento");
