...
//Creado 04/02/2019
//
//Sirve para los mensajes de alerta que son enviados por mail
//Cuando rssiEvento.php >> llama al archivo >> dyn_dataEvento:
//este archivo tiene la función de devolver los datos que corresponden al IP 
//**
...
include('db_ip.php');
    ...
    $IPE = strtoupper($_GET['ip']); 
    $query_ganancia = "SELECT ip, id_equipo, device_name, location FROM equipos WHERE ip LIKE '$IPE' ";
...
EOT;
        ...
        console.log("Estoy en dyn_data_evento");
